...
#else
        public NetworkChairManager chairManagerScript;
        void Start()
        {
            chairManagerScript = GameObject.Find("Network Manager").GetComponent<NetworkChairManager>();
